...
$(ObjDir)/sobel_test.cpp_pre.cpp.tb.o : sobel_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sobel_filter.cpp_pre.cpp.tb.o : sobel_filter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_filter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
