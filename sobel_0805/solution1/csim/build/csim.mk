...
HLS_SOURCES = ../../../sobel_test.cpp ../../../sobel_filter.cpp
...
$(ObjDir)/sobel_filter.o: ../../../sobel_filter.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../sobel_filter.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sobel_filter.d
